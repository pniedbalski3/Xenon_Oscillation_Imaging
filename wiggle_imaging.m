...
try
    ...
    Freq_tiled = Wiggle_Tools.tile_image(Freq(:,:,(firstslice-2):(lastslice+2)),3);
    Phase_tiled = Wiggle_Tools.tile_image(Phase(:,:,(firstslice-2):(lastslice+2)),3);
    R2_tiled = Wiggle_Tools.tile_image(R2(:,:,(firstslice-2):(lastslice+2)),3);
    Amp3_tiled = Wiggle_Tools.tile_image(Amp3(:,:,(firstslice-2):(lastslice+2)),3);
catch
    Anat_tiled1 = Wiggle_Tools.tile_image(H1_im,3,'nRows',3);
    BarHigh_tiled = abs(Wiggle_Tools.tile_image(High_Bar,3,'nRows',3));
    BarLow_tiled = abs(Wiggle_Tools.tile_image(Low_Bar,3,'nRows',3));
    Anat_tiled = Wiggle_Tools.tile_image(H1_im,3);
    RBCOsc_tiled = Wiggle_Tools.tile_image(RBC_Osc,3);
    RBCOscGas_tiled = Wiggle_Tools.tile_image(RBC_Osc_Gas,3);
    RBCOscDis_tiled = Wiggle_Tools.tile_image(RBC_Osc_Dis,3);
    BarOsc_tiled = Wiggle_Tools.tile_image(Bar_Osc,3);
    BarOscGas_tiled = Wiggle_Tools.tile_image(Bar_Osc_Gas,3);
    BarOscDis_tiled = Wiggle_Tools.tile_image(Bar_Osc_Dis,3);
    OscBin_tiled = Wiggle_Tools.tile_image(OscBinMap,3);
    RBCHigh_tiled = Wiggle_Tools.tile_image(High_RBC,3,'nRows',3);
    RBCLow_tiled = Wiggle_Tools.tile_image(Low_RBC,3,'nRows',3);
    Amp_tiled = Wiggle_Tools.tile_image(Amp(:,:,:),3);
    Amp2_tiled = Wiggle_Tools.tile_image(Amp2(:,:,:),3);
    Amp3_tiled = Wiggle_Tools.tile_image(Amp3(:,:,:),3);
    Freq_tiled = Wiggle_Tools.tile_image(Freq(:,:,:),3);
    Phase_tiled = Wiggle_Tools.tile_image(Phase(:,:,:),3);
    R2_tiled = Wiggle_Tools.tile_image(R2(:,:,:),3);
end
...
%set(RBCMontage,'color','white','Units','inches','Position',[1 1 8 7.2])
axes('Units', 'normalized', 'Position', [0 0 1 1])
[~,~] = Wiggle_Tools.imoverlay(Anat_tiled,RBCOsc_tiled,RBC_Lim,[0,0.99*ProtonMax],parula,1,gca);
axis off
colormap(parula);
...
%set(RBCMontage,'color','white','Units','inches','Position',[1 1 8 7.2])
axes('Units', 'normalized', 'Position', [0 0 1 1])
[~,~] = Wiggle_Tools.imoverlay(Anat_tiled,Amp_tiled,[0.0001 20],[0,0.99*ProtonMax],parula,1,gca);
axis off
colormap(parula);
cbar = colorbar(gca','Location','southoutside');
pos = cbar.Position;
...
%set(RBCMontage,'color','white','Units','inches','Position',[1 1 8 7.2])
axes('Units', 'normalized', 'Position', [0 0 1 1])
[~,~] = Wiggle_Tools.imoverlay(Anat_tiled,Amp2_tiled,[0.0001 20],[0,0.99*ProtonMax],parula,1,gca);
axis off
colormap(parula);
cbar = colorbar(gca','Location','southoutside');
pos = cbar.Position;
...
%set(RBCMontage,'color','white','Units','inches','Position',[1 1 8 7.2])
axes('Units', 'normalized', 'Position', [0 0 1 1])
[~,~] = Wiggle_Tools.imoverlay(Anat_tiled,Amp3_tiled,[0.0001 20],[0,0.99*ProtonMax],parula,1,gca);
axis off
colormap(parula);
cbar = colorbar(gca','Location','southoutside');
pos = cbar.Position;
