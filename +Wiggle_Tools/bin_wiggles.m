...
BP_RBC2Gas = bandpass(RBC2Gas,[0.5 2.5],SampF);
...
save(fullfile(write_path,'Wiggle_Binning.mat'),'Low_Indx','High_Indx','Tot_Proj','High_RBC2Bar','Low_RBC2Bar','Avg_Amp','Std_Amp','sixbin','fourbin','HR')
