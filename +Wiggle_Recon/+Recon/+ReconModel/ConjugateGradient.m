classdef ConjugateGradient < Reconstruction.Recon.ReconModel.GriddedReconModel
    properties
        iterations;
        weights;
    end
    methods
        function obj = ConjugateGradient(system_model, iter, verbose)
            ...
            obj = obj@Reconstruction.Recon.ReconModel.GriddedReconModel(system_model, verbose);
        ...
        function gridVol = grid(obj, data, traj, varargin)
            ...
            % using a sparser system model. This way you dont grid or
            % ungrid zeros unnecessarily
            if(isa(obj.system,'Reconstruction.Recon.SysModel.MatrixSystemModel'))
