...
%
classdef MatrixSystemModel < Reconstruction.Recon.SysModel.SystemModel
    properties
        A;
        ATrans;
        supersparse;
    ...
    methods
        ...
        function obj = MatrixSystemModel(traj, overgridFactor, imageSize, proximityObj, ...
            ...
            obj = obj@Reconstruction.Recon.SysModel.SystemModel(overgridFactor, imageSize, proximityObj, verbosity);
