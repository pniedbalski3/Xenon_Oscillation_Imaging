...
%
classdef L2Proximity < Reconstruction.Recon.SysModel.Proximity.Proximity
	methods
		function obj = L2Proximity(kernelObj, verbosity)
			% Call super constructor to build obj
			obj = obj@Reconstruction.Recon.SysModel.Proximity.Proximity(kernelObj, verbosity);
		...
		function [sample_idx,voxel_idx,kernel_vals] = ...
			...
			[sample_idx,voxel_idx,preovergrid_distances] = ...
				Reconstruction.Recon.SysModel.Proximity.sparse_gridding_distance_mex(traj',...
