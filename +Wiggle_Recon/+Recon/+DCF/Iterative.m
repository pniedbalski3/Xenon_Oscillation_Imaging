...
%
classdef Iterative < Reconstruction.Recon.DCF.DCF
    properties
        iterations;
    end
    methods
        ...
        function obj = Iterative(modelObj, dcfIiterations, verbosity)
            ...
            obj = obj@Reconstruction.Recon.DCF.DCF(verbosity);
            ...
            if(isa(modelObj,'TemporalSystemModel'))
                ...
                if(isa(modelObj,'Reconstruction.Recon.SysModel.MatrixSystemModel'))
